<?php
	...
	class TelegramBot
	{
		...
		public function setInlineKeyBoard($keyboard = []): false|static
        {
			if (!count($keyboard)) {
				if ($this->showErrors) {
		...
		public function setReplyKeyboard($keyboard,$resize_keyboard = true, $remove_keyboard = false): static
        {
		...
		public function removeInlineKeyboard(): static
        {
			unset($this->reply_markup['inline_keyboard']);
			return $this;
		}

		public function removeReplyKeyboard(): static
        {
		...
		public function sendMessage($text, $chat_id = null, $parse_mode = null): static
        {
			$content['text'] = $text;
		...
		public function editMessageText($text, $message_id = null, $chat_id = null, $parse_mode = null): static
        {
			$content['text'] = $text;
		...
		public function deleteMessage($message_id = null, $chat_id = null, $parse_mode = null): static
        {
			$content['chat_id'] = $chat_id ? $chat_id : $this->chat_id;
			$content['message_id'] = $message_id ? $message_id : $this->result->result->message_id;
		...
		public function sendPhoto($photo, $caption = null, $chat_id = null): static
        {
		...
		public function sendVideo($video, $caption = null, $chat_id = null): static
        {
			$chat_id = $chat_id ? $chat_id : $this->chat_id;
			$caption = $caption ? $caption : '';
		...
		public function sendAudio($audio, $caption = null, $chat_id = null): static
        {
			$chat_id = $chat_id ? $chat_id : $this->chat_id;
			$caption = $caption ? $caption : '';
		...
		public function sendDocument($document, $caption = null, $chat_id = null): static
        {
			$chat_id = $chat_id ? $chat_id : $this->chat_id;
			$caption = $caption ? $caption : '';
		...
		public function sendLocation($latitude, $longitude, $chat_id = null): static
        {
			$chat_id = $chat_id ? $chat_id : $this->chat_id;
		...
		public function sendContact($phone_number, $first_name, $chat_id = null): static
        {
			$chat_id = $chat_id ? $chat_id : $this->chat_id;
		...
		public function uploadProgress($resource, $downloaded, $download_size, $upload_size, $uploaded,  $action, $content): void
        {
		...
		public function setChannelId($channel_id) : static
		{
		...
		public function getChat($chat_id = null): static
		{
		...
		public function getChatMember($user_id = null, $chat_id = null): static
        {
		...
		public function getFile($file_id): static
		{
			$this->result = $this->request('getFile', compact('file_id'));
			return $this;
		}

		public function getFilePath($file_id): bool|string
        {
		...
		public function getUpdates($offset = null): mixed
        {
		...
		public function saveLogs($content): void
        {
			if ($this->saveLogs) {
		...
		public function httpResponseCode($url): string
        {
